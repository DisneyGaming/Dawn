...
This plan follows the current Dawn mission split: Lua owns story choices; native bindings identify assets and capabilities; shared services own execution, receipts, and lifecycle. It deliberately stops before implementation.
