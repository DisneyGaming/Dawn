...
Target: Destiny 2 build 86657, Dawn, `raid_envy_v310`  
...
Build a complete single-player Eater of Worlds using its recovered native content and the current Dawn mission infrastructure. Preserve the route, elemental cranium interactions, platform traversal, barrier encounter, Argos mechanics, presentation, and meaningful failure conditions. Adapt the requirements that depend on several players acting at once.
...
- [Shared executor](../../../Dawn/src/state/activity/coo/executor.h) and [Lua compiler](../../../Dawn/src/state/activity/coo/script_lua.cpp).
- [Population service](../../../Dawn/src/state/activity/coo/population_service.h), [object service](../../../Dawn/src/state/activity/coo/object_service.h), and [native service bridge](../../../Dawn/src/state/activity/coo/native_services.h).
- [Scene orchestration](../../../Dawn/src/state/activity/coo/scene_orchestration.h), [scene authority](../../../Dawn/src/state/activity/coo/native_scene_authority.h), and [cast authority](../../../Dawn/src/state/activity/coo/native_scene_cast_authority.h).
- [Dialogue service](../../../Dawn/src/state/activity/coo/dialogue_service.h), [event timeline](../../../Dawn/src/state/activity/coo/event_timeline.h), and [lifecycle service](../../../Dawn/src/state/activity/coo/lifecycle_service.h).
- [Native trigger support](../../../Dawn/src/state/activity/coo/native_player_trigger.h) and [device authority](../../../Dawn/src/state/activity/coo/native_device_authority.h).
- [Gateway bindings](../../../Dawn/src/state/activity/gateway/bindings.h) for authored progression and native devices.
- [Garden World bindings](../../../Dawn/src/state/activity/strike_bond/bindings.h), [boss cycle](../../../Dawn/src/state/activity/strike_bond/boss_cycle.h), and [ending/wipe support](../../../Dawn/src/state/activity/strike_bond/ending_wipe.h).
...
There is also population/world-object infrastructure under `Dawn/src/server/runtime/activity/`. Compare its contracts with the CoO services before choosing a boundary. Do not attach two competing owners to the same Eater source.

### 5.3 Proposed file organization

These paths are planned, not existing functionality:

- `Dawn/scripts/eater_of_worlds.lua`: authored phase graph and supported solo configuration.
- `Dawn/src/state/activity/eater_of_worlds/catalog.h`: generated or verified package identities.
...
- `Dawn/unit/eater_*_tests.cpp` and matching projects for the contracts actually added.
...
### Current Dawn authoring and execution

- [Mission implementation template](../../../Dawn/docs/MISSION-IMPLEMENTATION-TEMPLATE.md).
- [Lua authoring and current limits](../../../Dawn/docs/LUA-MISSION-AUTHORING.md).
- [New-mission reconstruction guide](../../../Dawn/docs/NEW-MISSION-RECONSTRUCTION-GUIDE.md).
- [Shared mission services](../../../Dawn/docs/UNIVERSAL-MISSION-SERVICES.md).
...
- [Garden World/Dendron implementation](../../../Dawn/docs/GARDEN-WORLD-IMPLEMENTATION.md): native boss cycles, shields, genuine death, and cleanup.
- [Active Omega arm/animation/movement migration](../../../Dawn/docs/NATIVE-OMEGA-ARM-MIGRATION.md): compiled-path verification, native control, and unresolved authority boundaries.
- [Omega ending teardown](../../../Dawn/docs/OMEGA-ENDING-TEARDOWN-TO-CUTSCENE.md): explicit retirement and observed arrival/presentation.
- [Beyond Infinity implementation](../../../Dawn/docs/BEYOND-INFINITY-IMPLEMENTATION.md): class/owner mistakes, device modes, native clocks, byte order, and the difference between live repair and installed acceptance.
- [Deep Storage implementation](../../../Dawn/docs/DEEP-STORAGE-IMPLEMENTATION.md): separate preload/arming/death contracts, independent waves, optional survivors, and persistent completion.
