...
13 September 2026. Build 86657. Dawn implementation `eater_of_worlds`.
...
- `Dawn/scripts/eater_of_worlds.lua` ships five active phases: arrival, reactor,
...
- `Dawn/src/state/activity/eater_of_worlds/` contains the controller, runtime,
...
- `Dawn/src/client/hooks/bootflow/eater_entity_id_startup.cpp` addresses the measured
...
- [Installation receipt](../../../build/coo/eater-final-validation-20260913/installation.json)
  ...
  `C:\Destiny 2 Development\.dawn\backups\lua-20260913-113012-c73d31b1`.
