...
The installed client scenario is `0x80B49E7A`, class `0x80809994`, named `raid_envy_v310` in the version-54 Dawn build-data cache. Its package-definition hash is `0x3B50D933`, its scenario blob is 1,462 bytes, and its SHA-256 is `eb43a19a565b833e71b51edbebed8669500fa7d17d207cd8c53718a9b5113d10`.
