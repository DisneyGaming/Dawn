...
authenticated Dawn local-player cache, the complete physics-component arrays, the
...
def capture(args: argparse.Namespace) -> Path:
    ...
    if "destiny2.exe" not in found or "steam_api64.dll" not in found:
        raise RuntimeError("Destiny and the installed Dawn module must both be loaded")
    ...
    try:
        ...
        save_blob(output, "player-component.bin", component, component_bytes, inventory,
                  "authenticated Dawn player component")
