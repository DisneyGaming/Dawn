...
The script reads the installed package set, the version-54 Sunrise cache, the installed metadata-bank fixture, and the supplied DECOMP_SHARE corpus. It regenerates `evidence/native-inventory.json` and validates:
