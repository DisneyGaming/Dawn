...
- `Sunrise/cache/build_data.bin`: version 54, 65,979,287 bytes, SHA-256 `4f0b3ceb3a63d59a970ec835a4645fbb096ab23eaa47b8753a9701e1976fe9c1`.
...
- `Sunrise/src/middleware/content/packages/tables/scenario_reader.*` and `slot_descriptor_reader.*`: field offsets and descriptor validation predicates used by the extractor.
- `Sunrise/docs/MISSION-IMPLEMENTATION-TEMPLATE.md`, `LUA-MISSION-AUTHORING.md`, `NEW-MISSION-RECONSTRUCTION-GUIDE.md`, and `UNIVERSAL-MISSION-SERVICES.md`: current authoring, service ownership, evidence, and validation guidance.
