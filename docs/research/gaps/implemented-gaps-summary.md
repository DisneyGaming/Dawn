...
This document summarizes the capabilities implemented in our current Dawn source compared with the build state described in `MISSING.md`. The baseline comparison was performed September 7, 2026, comparing our inspected source tree against written descriptions.
...
## 2. Implemented Capabilities in Dawn Source
...
- **Sources:** `Dawn/src/state/activity/coo/executor.h`, `coo/mission_script.cpp`, `Dawn/scripts/`
...
- **Sources:** `Dawn/src/state/activity/coo/`, `Dawn/docs/UNIVERSAL-MISSION-SERVICES.md`
...
- **Sources:** `Dawn/src/state/activity/coo/population_service.h`, `Dawn/src/client/hooks/bootflow/omega_mission_health.inl`
...
- **Sources:** `Dawn/src/state/activity/coo/lifecycle_service.h`, `Dawn/src/state/activity/lifecycle_generation.h`, `Dawn/docs/COO-EXECUTOR.md`
...
- **Sources:** `Dawn/src/server/bap/encrypted/push/activity/activity_roster_push.cpp`
...
- **Sources:** `Dawn/src/server/bap/region_lineage.h`, `Dawn/src/server/bap/encrypted/activity_transaction/activity_transaction_notifications.cpp`
...
- **Sources:** `Dawn/src/server/bap/encrypted/push/snapshot/roster_snapshot.cpp`, `Dawn/src/server/bap/encrypted/queuez/queuez_outcome_staging.cpp`
...
- **Sources:** `Dawn/src/state/activity/coo/object_service.h`, `Dawn/docs/UNIVERSAL-MISSION-SERVICES.md`
...
- **Sources:** `Dawn/src/client/hooks/bootflow/omega_mission_motion.inl`, `Dawn/src/state/activity/coo/omega_ending_definition.h`, `Dawn/docs/COO-EXECUTOR.md`
...
- **Sources:** `Dawn/src/server/bap/encrypted/matchmaking/matchmaking_route.cpp`
...
- **Sources:** `Dawn/src/client/content/scenarios/scenario_roster_build.cpp`, `Dawn/src/server/bap/encrypted/push/activity/activity_roster_snapshot.cpp`
...
- **Sources:** `Dawn/src/middleware/datagen/character_record/character_record_encoder.cpp`
