...
CHANGED={
 ...
 'Dawn/src/state/activity/gateway/controller.h',
 'Dawn/src/state/activity/gateway/controller.cpp',
 'Dawn/src/state/activity/gateway/ending_receipts.h',
 'Dawn/src/state/activity/gateway/runtime.cpp',
 'Dawn/src/client/hooks/bootflow/gateway_module_receipts.inl',
 'Dawn/src/client/hooks/bootflow/gateway_module_damage.h',
 'Dawn/src/client/hooks/bootflow/omega_arc_charge_receipts.cpp',
 'Dawn/src/client/hooks/bootflow/gateway_module_damage_hooks.inl',
 'Dawn/unit/gateway_opening_tests.cpp',
 'Dawn/docs/GATEWAY-RECONSTRUCTION.md',
}
def main():
 ...
 with zipfile.ZipFile(archive) as z:
  for name in z.namelist():
   if (name.startswith(('Dawn/src/','Dawn/unit/','Dawn/scripts/')) or name=='Dawn/Dawn.vcxproj') and name not in CHANGED:
