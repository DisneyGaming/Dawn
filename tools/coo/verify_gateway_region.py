"""Validate the Gateway return-region ownership correction; do not install or launch."""
import json,subprocess,sys,zipfile
from pathlib import Path
import verify
ROOT=verify.ROOT
OUT=ROOT/'build/coo/validation-gateway-region'
CHANGED={
...
def main():
 ...
 accepted=ROOT/'build/coo/validation-gateway-ending/candidate-source.zip'
 assert verify.digest(accepted)=='280067176e604c32e00e72b2b1ed2374f66fe56a66455ee537f305da3e7b7735'
 protected=0
 ...
 print('Gateway region ownership candidate built and verified; native boundary retest remains pending.',flush=True)
