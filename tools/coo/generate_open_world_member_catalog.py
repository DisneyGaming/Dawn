...
HEADER_PATH = ROOT / "Sunrise/src/state/activity/coo/open_world_member_catalog.h"
...
def _mercury_capability_bindings() -> list[tuple[int, int] | None]:
    text = (ROOT / "Sunrise/src/server/runtime/activity/mercury_populations.h").read_text()
...
def _mercury_patrol_capabilities() -> list[int]:
    text = (ROOT / "Sunrise/src/server/runtime/activity/mercury_freeroam_runtime.h").read_text()
