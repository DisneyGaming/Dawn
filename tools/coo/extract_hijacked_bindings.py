...
def native_text(data):
    ...
    lines=['// Generated by extract_hijacked_bindings.py; native package identities.', '#pragma once','#include "catalog.h"','namespace dawn::state::activity::hijacked {',
...
def main():
    ...
    directory=packages.ROOT/'Dawn/src/state/activity/hijacked'
