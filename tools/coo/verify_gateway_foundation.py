...
CHANGED={
 'Dawn/src/client/hooks/bootflow/omega_dialogue_dispatch_probe.cpp',
 'Dawn/src/client/player/player_position.cpp',
 'Dawn/src/middleware/bap/activity_message/activity_sensor_auth_bodies_other_missions.cpp',
