"""Validate and stage Gateway mainland continuation; do not install or launch the game."""
import json,subprocess,sys,zipfile
from pathlib import Path
import verify
ROOT=verify.ROOT
OUT=ROOT/'build/coo/validation-gateway-mainland'
CHANGED={
...
def main():
 ...
 accepted=ROOT/'build/coo/validation-gateway-position/candidate-source.zip'
 assert verify.digest(accepted)=='799960486e83272e699df9f72522baa58ba4f987c268da0897af6dafe72bd500'
 protected=0
 ...
 print('Gateway mainland continuation candidate built and verified.',flush=True)
