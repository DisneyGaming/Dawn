...
def native_text(data):
    ...
    lines=['// Generated by extract_deep_storage_bindings.py; native package identities.', '#pragma once','#include "catalog.h"','namespace dawn::state::activity::deep_storage {',
...
def mechanisms_text():
    ...
    lines=['// Generated package mode ranges. Mode direction still needs native/live verification.', '#pragma once','#include "catalog.h"','namespace dawn::state::activity::deep_storage {',
...
def main():
    ...
    if args.check:
        ...
        destination=packages.ROOT / 'Dawn/src/state/activity/deep_storage'
