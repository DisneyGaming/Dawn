...
ROOT = verify.ROOT
SCRIPTS = ('omega.lua', 'deadly_trial.lua', 'gateway.lua', 'beyond_infinity.lua', 'deep_storage.lua', 'hijacked.lua', 'strike_pact.lua', 'mercury_freeroam.json', 'infinite_abyss.json')
