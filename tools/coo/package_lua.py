...
ROOT = verify.ROOT
SCRIPTS = ('launchpad.lua', 'omega.lua', 'deadly_trial.lua', 'gateway.lua', 'beyond_infinity.lua', 'deep_storage.lua', 'hijacked.lua', 'strike_pact.lua', 'strike_bond.lua', 'mission_pact.lua', 'mission_bond.lua', 'eater_of_worlds.lua', 'mercury_freeroam.json',
