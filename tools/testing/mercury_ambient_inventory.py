...
Usage: python mercury_ambient_inventory.py --reader-dir D:/Sunrise-work/scripts
       --inventory D:/Sunrise-work/mercury_inventory/components.json --output DIR
...
def header(groups):
    ...
    lines.extend(['}};', '[[nodiscard]] constexpr const Group* find(std::uint32_t key) noexcept {',
                  ...
                  '    return nullptr;', '}', '} // namespace sunrise::state::activity::coo::mercury::ambient', ''])
    return '\n'.join(lines)
