...
for filename,expected in [('lifetime-before.body',0),('lifetime-haunted13.body',13)]:
...
(base/'haunted_forest_lifetime_native_decode.json').write_text(json.dumps(report,indent=2)+'\n');print(json.dumps(report,indent=2))
