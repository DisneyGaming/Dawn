...
private:
    ...
    /** Parses the default-off top-level experiment group. */
    [[nodiscard]] bool experiment_settings(experiments::Omega& output) noexcept;
    /** Parses independently controlled Omega experiments. */
    [[nodiscard]] bool omega_experiment_settings(experiments::Omega& output) noexcept;
    /**
