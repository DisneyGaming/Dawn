...
struct PendingMutation final {
    ...
    /** Exact activity lifetime captured with the revision guards. */
 ...
 */
[[nodiscard]] bool prepare_grant(ActivityInstanceKey key,
                                 std::size_t requestedCount,
                                 PendingMutation& mutation) noexcept;
 ...
 */
[[nodiscard]] bool prepare_release(ActivityInstanceKey key,
