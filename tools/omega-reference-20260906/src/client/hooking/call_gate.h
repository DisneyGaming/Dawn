...
namespace sunrise::client::hooking {
 ...
 * through the native trampoline call and all post-work. Quiescing disables Sunrise-owned work but
...
public:
    ...
    public:
        ...
        /** @return True when this call may perform Sunrise-owned observation or mutation work. */
    ...
    /** Allows newly entered calls to perform their scoped Sunrise-owned work. */
    void accept() noexcept {
        accepting_.store(true, std::memory_order_release);
    }

    /** Stops newly entered calls doing Sunrise-owned work while native forwarding remains live. */
