...
| --- | --- |
| Mission definition | `Dawn/scripts/deadly_trial.json` |
| Loader / document code | `Dawn/src/state/activity/coo/mission_script.cpp`, `script_views.h` |
| Executor and shared services | `Dawn/src/state/activity/coo/executor.h` and neighboring service files |
| Mission adapter | `Dawn/src/state/activity/deadly_trial/controller.h`, `deadly_trial_controller.cpp`, `deadly_trial_runtime.cpp` |
| Mission native data / authority | `Dawn/src/state/activity/deadly_trial/catalog.h`, `authority.h`, `skiff_authority.h`, `navigation.h`, `ending_audio.h` |
| Accepted revival integration | `Dawn/src/client/hooks/bootflow/deadly_trial_revival.h/.cpp` |
| Lifetime association repair | `Dawn/src/client/hooks/bootflow/deadly_trial_lifetime.h/.cpp` |
| Hook lifecycle | `Dawn/src/client/hooks/bootflow/bootflow_hook_lifecycle.cpp` |
| Mission tests | `Dawn/unit/deadly_trial_tests.cpp`, `deadly_trial_tests.vcxproj`, and `fixtures/deadly_trial_lifetime_fixture.h` |
| Build and other regression suites | `Dawn/Dawn.vcxproj`, `Dawn/unit/coo_script_tests.vcxproj`, `coo_mission_script_tests.vcxproj`, `coo_universal_services_tests.vcxproj` |
| Build helper | `tools/coo/verify.py` |
| Mission history | `Dawn/docs/DEADLY-TRIAL-RECONSTRUCTION.md` |
