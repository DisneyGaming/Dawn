...
Ikora's sequence works by giving the native Scene graph a correctly authorized source actor, then allowing its animation wrappers, dialogue, and effects to follow the authored graph. The mission ending follows the same principle at a larger scale: Dawn supplies the progression and transition commands, while the native cinematic owns its cast, cameras, animation, and dialogue.
...
Source: [archive integration notes](<C:/Destiny 2 Development/Dawn/OMEGA-SRC-PORT.md>), [DLL project](<C:/Destiny 2 Development/Dawn/Dawn.vcxproj>).
...
Source: [source body](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/activity_sensor_auth_bodies.cpp:600>), [Scene body](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/activity_sensor_auth_bodies.cpp:537>), [ordered publication](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/activity_sensor_auth_encoder.cpp:375>).
...
Source: [opening readiness and stage progression](<C:/Destiny 2 Development/Dawn/src/server/bap/encrypted/push/activity/activity_roster_snapshot.cpp:786>).
...
The graph combines this event with its native predecessor-completion conditions to advance the orb into the portal-opening wrappers. Dawn supplies the missing external input; the native graph owns the internal animation sequencing and authored delays.
...
This keeps actor dialogue tied to native animation events rather than placing a second copy on an independent host schedule. Source: [dialogue ownership and durations](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_presentation_rules.h:27>).
...
The native graph's authored 12.5-second timer produces output **`792AAA50`**. Dawn receives that output through the exact Scene sense slot `D00142CF/43/1`, validates the binding, generation, full body, and fresh revision, then latches the release. The ordinary authority publisher sends **position 0, revision 2, snap disabled**, allowing the native device presentation to dissolve smoothly.
...
Source: [lattice parser and persistent state](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ikora_lattice.h>), [gate body](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/activity_sensor_auth_bodies.cpp:119>), [authored graph and device evidence](<C:/Users/gauta/Downloads/docs/docs/omega/reference/IKORA-LATTICE.md>).

```mermaid
sequenceDiagram
    participant H as Dawn host
...
The successful native-source investigation used `ikora_carrier_model_suppression=false`. The current local [settings file](<C:/Destiny 2 Development/Dawn/settings.json:25>) has that historical option set to **true**, and the active probe still contains the narrowly scoped render-model suppression path. That means this checkout should not be described as having removed the experiment entirely.
...
Source: [effect observation](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_ikora_origin_probe.cpp:681>), [legacy model suppression](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_ikora_origin_probe.cpp:778>).
...
This movie owns Osiris, Ikora, Sagira, the Guardian, cameras, animation, and its internal dialogue. Dawn activates its native controller. The short Lair intro is a separate controller/resource, so its completion cannot satisfy the ending.
...
Source: [ending identities and state machine](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending_rules.h>), [current cinematic authority body](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/activity_sensor_auth_bodies.cpp:657>).
...
Source: [death completion gate](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_first_lair_encounter.h:626>), [request validation and action claim](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending.cpp:166>).
...
Source: [dialogue completion predicate](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_presentation_rules.h:126>), [submission handling](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_presentation_rules.h:361>).
...
Source: [terminal roster construction](<C:/Destiny 2 Development/Dawn/src/server/bap/encrypted/push/activity/omega_lair_roster.h:292>), [native cleanup observer](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_dialogue_dispatch_probe.cpp:2148>), [before/after cleanup checks](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_teardown_native.h:173>).
...
Source: [teleport transaction and synchronization predicate](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending_transit_rules.h>), [activity/member binding](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending.cpp:311>), [membership projection](<C:/Destiny 2 Development/Dawn/src/server/bap/encrypted/push/activity/activity_membership_push.cpp:70>).
...
Source: [native controller observation](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_lair_cinematic.cpp:1695>), [resource registration](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_lair_cinematic.cpp:1767>), [runtime seed predicate](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/sensor_auth_update.h:18>), [seed writer](<C:/Destiny 2 Development/Dawn/src/middleware/bap/activity_message/activity_sensor_auth_encoder.cpp:337>).
...
Source: [playback state machine](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending_rules.h:148>), [start/finish forwarding](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending.cpp:264>).
...
The related started/finished incident rows are 5239 and 1685, but they do not replace the controller's revision-qualified completion check. Source: [incident identities and skip behavior](<C:/Destiny 2 Development/Dawn/src/state/activity/omega_ending_rules.h>).
...
Source: [complete return-handoff implementation](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/omega_activity_handoff.inl>), [frame owner and loading suppression hook](<C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/world_step.cpp>).
...
For the current implementation, start with [archive encounter tests](<C:/Destiny 2 Development/Dawn/unit/omega_archive_encounter_tests.cpp:163>), [archive protocol tests](<C:/Destiny 2 Development/Dawn/unit/omega_archive_protocol_tests.cpp>), and [startup roster regression test](<C:/Destiny 2 Development/Dawn/unit/omega_forest_roster_tests.cpp:140>). The older `omega_ending_tests.cpp` imports the earlier `omega/omega_ending_runtime.h`; its name alone does not make it coverage of the active ending controller.
