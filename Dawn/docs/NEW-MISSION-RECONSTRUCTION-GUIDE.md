# Reconstructing a new mission with Dawn
...
- The complete relevant run log, including mission selection and the script-load line. The primary log here is `C:/Destiny 2 Development/Dawn/logs/dawn.log`; preserve it before rotation.
...
Read [Lua mission authoring](</C:/Destiny 2 Development/Dawn/docs/LUA-MISSION-AUTHORING.md>), [universal mission services](</C:/Destiny 2 Development/Dawn/docs/UNIVERSAL-MISSION-SERVICES.md>), and the [scripts README](</C:/Destiny 2 Development/Dawn/scripts/README.md>).

Use [Deadly Trial Lua](</C:/Destiny 2 Development/Dawn/scripts/deadly_trial.lua>) and [Gateway Lua](</C:/Destiny 2 Development/Dawn/scripts/gateway.lua>) as the main examples of authored mission decisions. Pair each example with its own native files; matching names from different missions do not imply matching native assets.

Useful source entry points:

- [Deadly Trial bindings](</C:/Destiny 2 Development/Dawn/src/state/activity/deadly_trial/bindings.h>) and [profile](</C:/Destiny 2 Development/Dawn/src/state/activity/deadly_trial/profile.h>).
- [Gateway bindings](</C:/Destiny 2 Development/Dawn/src/state/activity/gateway/bindings.h>), [controller](</C:/Destiny 2 Development/Dawn/src/state/activity/gateway/controller.cpp>), and [runtime](</C:/Destiny 2 Development/Dawn/src/state/activity/gateway/runtime.cpp>).
- [Shared executor](</C:/Destiny 2 Development/Dawn/src/state/activity/coo/executor.h>), [mission compiler](</C:/Destiny 2 Development/Dawn/src/state/activity/coo/mission_script.cpp>), [Lua front end](</C:/Destiny 2 Development/Dawn/src/state/activity/coo/script_lua.cpp>), and [builder definitions](</C:/Destiny 2 Development/Dawn/src/state/activity/coo/script_lua_dsl.h>).
- [Omega Lua](</C:/Destiny 2 Development/Dawn/scripts/omega.lua>) and [Omega native profile](</C:/Destiny 2 Development/Dawn/src/state/activity/coo/omega_script.cpp>) for its specific mechanics and composition interface.
...
C:/Destiny 2 Development/
  Dawn/scripts/<mission>.lua
  Dawn/src/state/activity/<mission>/
  ...
  Dawn/unit/<mission>_tests.cpp
  Dawn/unit/<mission>_tests.vcxproj
  Dawn/docs/<MISSION>-RECONSTRUCTION.md
...
Useful read-side code includes [current-process memory reader](</C:/Destiny 2 Development/Dawn/src/client/memory/current_process_memory.h>), [component resolver](</C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/coo_native_components.h>), and [enemy readiness probes](</C:/Destiny 2 Development/Dawn/src/client/hooks/bootflow/coo_enemy_readiness.h>). The current-process reader operates inside its own process; it is not an external attach-and-edit tool.
...
```text
Reconstruct this mission using the current Dawn Lua/C++ architecture.
