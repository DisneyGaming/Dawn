...
Dendron's aim and firing are still handled by the game's native AI. Dawn
...
puts Dendron into the rooftop fight using his native behavior package. Dawn
...
The original function always runs first. If it returns false, Dawn does
