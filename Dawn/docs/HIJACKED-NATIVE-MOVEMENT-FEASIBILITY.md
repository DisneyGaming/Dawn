...
Run `python Dawn/unit/fixtures/verify_hijacked_movement_target.py` from the repository root. It pins the original image SHA256 to63d128f1c759b92d32b0f226bcbec828bc58cef193ee0df6fdd582bd0290ed1e and executes original4FFEC0 and4E2990 in Unicorn.
