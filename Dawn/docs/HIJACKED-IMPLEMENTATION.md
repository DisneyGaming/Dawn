...
The user's next run reported no objective or dialogue, followed by Baboon. The preserved `build/coo/hijacked-baboon-research/dawn-before-fix.log` shows primary activity001 joined at77641ms, auxiliary group activity002 joined at92516ms, successful type5 mission updates through104688ms, and Hijacked's first active frame at105688ms. No type2 clock notification or subsequent type5 update was emitted. At125203ms the native primary activity watchdog reported20518ms without a host update. A requested objective in executor state is not evidence of native display.
...
tests and the Release Dawn DLL. This includes optional-room traversal,
...
Release Dawn DLL. The focused cases include adjusted native endpoints,
...
Release suites and the Release Dawn DLL are built. Focused coverage includes
...
hijacked_tests, Release hijacked_catalog_tests and the Release Dawn DLL are
...
to Release hijacked_tests, hijacked_catalog_tests and Dawn DLL. Focused
...
Release suites and Release Dawn build are required. Focused replay checks
...
to Release Hijacked gameplay/catalog suites and Release Dawn. Tests cover
...
suites and Dawn build are used. The existing retirement fixture also verifies
...
hijacked_tests, hijacked_catalog_tests and Dawn DLL only. The focused catalog
...
to Release Hijacked route/catalog suites and the Dawn DLL. Added coverage
...
is Release hijacked_tests, hijacked_catalog_tests, and Dawn DLL only. Offline
...
build/coo/hijacked-loadzone-investigation-65288/findings.json and dawn.log.
...
to Release Hijacked route/catalog and Dawn. Focused coverage checks the exact
...
to Release hijacked_tests, hijacked_catalog_tests, and Dawn DLL. Added focused
...
Release hijacked_tests, hijacked_catalog_tests and Dawn. Existing opening
