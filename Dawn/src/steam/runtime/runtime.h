 ...
 * joining snapshot's seed; the Client replaces that row with the native player id carried by its
 * managed-session player-add.
 */
inline constexpr std::uint64_t kLocalSteamId = 0x0110000130AA9EC5ULL;
