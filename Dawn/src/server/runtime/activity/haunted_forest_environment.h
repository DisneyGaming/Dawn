...
namespace dawn::server::runtime::activity::haunted_forest::environment {

namespace mode = dawn::server::runtime::activity::haunted_forest::mode;
namespace registry = state::activity::coo::registry;
namespace round = dawn::server::runtime::activity::round_environment;
namespace status_effect = dawn::server::runtime::activity::status_effect;
