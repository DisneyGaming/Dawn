...
namespace placementProbe=dawn::client::hooks::bootflow::native_local_placement_probe;
namespace gatewayRead=dawn::client::hooks::bootflow::gateway_native;
...
void poll_transit_targets(Entry& entry,std::uint64_t now) noexcept {
    ...
    std::array<transit_effect::TargetRequest,21> pending{};
