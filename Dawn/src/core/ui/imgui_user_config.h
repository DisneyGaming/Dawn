...
// Dawn does not let Dear ImGui read or write files at runtime.
#define IMGUI_DISABLE_FILE_FUNCTIONS
// Every Dear ImGui allocation must use Dawn's bounded static arena.
...
// The game stays the only input-method owner while Dawn is loaded.
