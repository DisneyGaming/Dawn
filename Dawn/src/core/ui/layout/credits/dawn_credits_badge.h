...
/** Dawn source and release credits live at this project URL. */
inline constexpr wchar_t kSourceUrl[] = L"https://github.com/stanuwu/Sunrise";
inline constexpr wchar_t kSundialUrl[] = L"https://github.com/KyleThmpsn/sundial";
enum class Project { original, sundial };
