...
/**
 * Builds configured ability selections and every standard combination for the nine subclasses.
 ...
 * @return True when the table reads and output fits; an unreadable subclass is skipped.
 */
[[nodiscard]] bool
