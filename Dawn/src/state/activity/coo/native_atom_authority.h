...
// is transcribed from the accepted Dawn host's proven encoders
...
namespace dawn::state::activity::coo::native_atom {
...
// move, and only ever the untargeted mode -1; the Dawn source fixes the field widths and biases
