...
// from the accepted Dawn host's proven encoder
...
#include <cstddef>
#include <cstdint>
namespace dawn::state::activity::coo::native_generator {
...
// no proven Dawn host path ever sets them, so their inputs are unknown. Left clear.
...
/** One 8080500B record. Bias arithmetic wraps in 32 bits exactly as the Dawn encoder's does;
