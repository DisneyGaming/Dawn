...
namespace wire=dawn::middleware::bap::activity_message::adventure_start;
namespace host=dawn::server::runtime::activity::adventure_start;
namespace mercury=dawn::server::runtime::activity::adventure::mercury;
namespace route_fixture {
static dawn::state::activity::ActivityState store{};
...
namespace dawn::state::activity::adventure_destination {
...
Encoded encode(std::int16_t activity=1076,std::uint8_t revision=3,
    ...
    Encoded out{};
    dawn::middleware::encoding::bits::Writer w(out.data);
...
void adapter_routes(const Encoded& encoded) {
    ...
    namespace bap=dawn::server::bap::encrypted::activity_message;
    ...
    dawn::middleware::bap::activity_message::Request envelope{};
...
int main(int argc,char** argv) {
    ...
    if(argc>2) {
        namespace global=dawn::middleware::bap::activity_message::global_activity_state;
