...
namespace frozen=dawn::state::activity::frozen_combat;
...
public:
    ...
    dawn::state::activity::omega_archive_arm::Ledger arm;
    dawn::state::activity::omega_archive_intro::Ledger programs;
    ...
    void compare() {
        ...
        for(const auto& scene:dawn::state::activity::omega_rescue_npc::kScenes) {
