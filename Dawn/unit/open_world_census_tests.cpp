...
namespace dawn::core::settings {Settings g_censusSettings{};const Settings& get() noexcept {return g_censusSettings;}}
...
namespace census=dawn::server::runtime::activity::open_world_census;
...
int main(int argc,char**){
    ...
    require(!dawn::state::activity::open_world_members::enabled(),"disabled census enabled client capture");
    dawn::core::settings::g_censusSettings.omegaExperiments.unsafeDiagnostics=true;
    require(!census::enabled(),"broad unsafe diagnostics enabled census");
    dawn::core::settings::g_censusSettings.omegaExperiments.openWorldCensus=true;
    ...
    require(dawn::state::activity::open_world_members::enabled(),"census did not enable member sidecar");
    std::this_thread::sleep_for(std::chrono::milliseconds(20));
    census::emit(record);census::shutdown();
    require(!dawn::state::activity::open_world_members::enabled(),"shutdown left member capture active");
