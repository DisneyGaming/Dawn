...
namespace omega_reveal_source=dawn::client::hooks::bootflow::omega_reveal_source;
namespace omega_cannon_delivery=dawn::client::hooks::bootflow::omega_cannon_delivery;
...
void captured_delivery_cases() {
    namespace delivery=dawn::client::hooks::bootflow::omega_rescue_delivery;
    const auto folder=std::filesystem::path(__FILE__).parent_path()/"fixtures/omega_rescue";
    ...
    check(!dawn::client::hooks::bootflow::omega_lair_delivery::adopted(npc,body),"capture reproduces missing native adoption");
