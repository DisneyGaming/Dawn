...
namespace policy = dawn::server::runtime::activity::initial_arrival;
namespace haunted = dawn::server::runtime::activity::haunted_forest;

namespace profile_fixture {
std::array<dawn::state::build_data::activities::Definition, 4095> catalog{};
