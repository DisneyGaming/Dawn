...
using dawn::state::activity::SceneGeneration;
using dawn::state::activity::omega::retirement_mask;
using dawn::state::activity::omega::SceneRetirement;
using dawn::state::activity::omega::SceneRetirementMailbox;
