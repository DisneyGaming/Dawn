...
using namespace dawn::client::hooks::bootflow::opening_authority::scene_capture;
...
static_assert(!dawn::middleware::bap::activity_message::sensor_auth_update::
...
void oracle_is_private_exact_and_never_publishes() {
    ...
    CHECK(!dawn::middleware::bap::activity_message::sensor_auth_update::
              kOmegaSceneAuthorityBodyReady);
}
