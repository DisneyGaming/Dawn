...
#include <filesystem>
#include <fstream>
namespace runtime=dawn::server::runtime::activity::world_object;
namespace data=dawn::server::runtime::activity::mercury::public_events::world;
namespace place=dawn::middleware::bap::activity_message::native::placement;
namespace device=dawn::middleware::bap::activity_message::native::world_device;
