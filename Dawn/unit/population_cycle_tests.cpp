...
namespace rt=dawn::server::runtime::activity::population;
namespace wire=dawn::middleware::bap::activity_message::native::population;
...
int main() {
    ...
    CHECK(dawn::middleware::bap::activity_message::native::combatant_source::write_source(normalWriter,normal.entries[0].source));
    ...
    CHECK(dawn::middleware::bap::activity_message::native::combatant_source::write_source(retiredWriter,retiring));
    ...
    CHECK(!dawn::middleware::bap::activity_message::native::combatant_source::write_source(invalidRetire,retiring));
    ...
    dawn::middleware::bap::activity_message::sensor_auth_update::Group group{kKey,types,flags,indices};
    std::array<std::uint32_t,1> keys{kKey};
    dawn::middleware::bap::activity_message::sensor_auth_update::BubbleSubBlock block{7,keys,{},{}};
    dawn::middleware::bap::activity_message::sensor_auth_update::Roster roster{};roster.groupCount=1;roster.groups[0]=group;roster.bubbleSubBlocks=std::span(&block,1);
