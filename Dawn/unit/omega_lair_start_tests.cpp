...
namespace {
namespace start=dawn::state::activity::omega::lair_start;
namespace authority=dawn::state::activity::omega::lair_authority;
...
void native_delivery(const std::filesystem::path& capture) {
    namespace delivery=dawn::client::hooks::bootflow::omega_lair_delivery;
...
void mission_packets() {
    ...
    namespace auth=dawn::state::activity::omega::mission_authority;
    namespace devices=dawn::state::activity::omega::mission_devices;
...
void real_receipt_publication(const std::filesystem::path& fixtures) {
    ...
    auto& receipts = dawn::core::log::firstWaveReceipts;
