...
#include <sstream>
#include <limits>
namespace ds=dawn::state::activity::hijacked;
...
static void presentation_records() {
    namespace p=dawn::client::hooks::bootflow::hijacked_presentation;
...
static void held_region_routing() {
    ...
    namespace membership=dawn::state::activity::membership;
