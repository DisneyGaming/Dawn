...
static void cycle_boundary_regressions() {
    namespace p=dawn::client::hooks::bootflow::strike_bond_boss_cycle;
...
static void cycle_command_regressions() {
    ...
    namespace intro=dawn::client::hooks::bootflow::strike_bond_intro_release;
...
static void ending_scene_cue_regressions() {
    namespace path=dawn::client::hooks::bootflow::garden_ending_scene_path;
...
static void ending_handoff_regressions() {
    namespace tr=dawn::state::activity::omega_ending_transit;
