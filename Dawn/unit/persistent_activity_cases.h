...
void persistent_activity_cases() {
    ...
    std::ifstream input("Dawn/scripts/mercury_freeroam.json",std::ios::binary);CHECK(input.good());
    ...
    namespace placement_wire=dawn::middleware::bap::activity_message::native::placement;
