...
namespace nf = dawn::state::activity::nightfall;
...
void health_reference_tests() {
    namespace player=dawn::client::activity::nightfall_player;
    namespace native=dawn::client::hooks::bootflow::gateway_native;
...
int main() {
    ...
    dawn::state::PendingProfileItemAcquisition malformed{};
    ...
    check(dawn::state::profile_currency_grant_after_image_exact(malformed),
    ...
    check(dawn::state::profile_currency_credit(100,250000,5000)==5000
        && dawn::state::profile_currency_credit(249000,250000,5000)==1000
        && dawn::state::profile_currency_credit(250000,250000,5000)==0,
    ...
    dawn::client::activity::nightfall_player::Cursor cursor{};
