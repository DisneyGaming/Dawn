...
#include <fstream>
#include <vector>
namespace f=sunrise::server::runtime::activity::public_event::engagement_feedback;
...
int main(int argc,char** argv){
    ...
    namespace sense=sunrise::middleware::bap::activity_message::native::engagement_sense;
    ...
    {
        using Gate=sunrise::server::runtime::activity::public_event::EngagementGate;
