...
#include <memory>
#include <vector>
namespace shared=sunrise::client::content::scenarios::campaign_shared;
namespace layouts=sunrise::state::build_data::scenarios;
namespace records=sunrise::state::build_data::cache::records;
namespace pact=sunrise::server::bap::encrypted::push::activity::strike_pact_roster;
namespace bond=sunrise::server::bap::encrypted::push::activity::strike_bond_roster;
