...
void live_ikora_startup() {
    ...
    namespace readiness = sunrise::server::bap::encrypted::activity_message::omega_roster_readiness;
    namespace monitor = sunrise::server::bap::encrypted::activity_message::omega_monitor_edges;
