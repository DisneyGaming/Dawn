...
constexpr sunrise::state::activity::ActivityInstanceKey kInstance{0x9EAA300100200001ULL, {1}};
...
const auto latestRoster = hex(sunrise::unit::fixtures::omega_native_sense_capture(1));
const auto latestOpening = hex(sunrise::unit::fixtures::omega_native_sense_capture(9));
const auto latestRelease = hex(sunrise::unit::fixtures::omega_native_sense_capture(13));
const auto latestRetained = hex(sunrise::unit::fixtures::omega_native_sense_capture(29));
