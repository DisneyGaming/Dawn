...
namespace eye = sunrise::client::hooks::bootflow::omega_boss_eye_diagnostics;
namespace omega_boss_eye_diagnostics = eye;
namespace graph = sunrise::client::hooks::bootflow::omega_boss_graph;
namespace observation = sunrise::client::hooks::bootflow::omega_boss_graph_observation;
namespace fixture {
unsigned checks{};
