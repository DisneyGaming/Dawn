...
namespace clockwire=sunrise::middleware::bap::activity_message::native::activity_clock;
namespace capture=sunrise::middleware::bap::activity_message::native::capture_controller;
namespace bits=sunrise::middleware::encoding::bits;
namespace hostclock=sunrise::server::runtime::activity::activity_clock;
int checks{},failures{};
