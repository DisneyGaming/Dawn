#define SUNRISE_SENSOR_HEAP_FULL_COHORT_TEST 1
...
using namespace sunrise::client::hooks::network::lifecycle::sensor_state_heap_full_cohort;
namespace fanout = sunrise::client::hooks::activity_lifecycle;
