...
namespace slot_transactions = sunrise::state::activity::entity_slots::transactions;
namespace startup = sunrise::client::hooks::bootflow::eater_entity_id_startup;
...
void grant_uses_the_real_free_lease_transaction_and_rejects_stale_commit() {
    using sunrise::state::runtime::storage::g_state;
    g_state = {};
