...
namespace frozen = sunrise::state::activity::frozen_shared_presentation;
...
struct NewPorts final : omega::Controllers {
    ...
    sunrise::state::activity::omega_first_lair::Authority encounter(std::uint64_t,std::uint32_t gen,bool) noexcept override {
    ...
    sunrise::state::activity::omega_ending::Authority ending(const omega::Input&) noexcept override { calls.push_back(3);return value.ending; }
...
struct OldPorts final : old::Controllers {
    ...
    sunrise::state::activity::omega_first_lair::Authority encounter(std::uint64_t run,std::uint32_t gen,bool selected) noexcept override {
    ...
    sunrise::state::activity::omega_ending::Authority ending(const old::Input& input) noexcept override {
