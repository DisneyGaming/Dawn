...
namespace capture = sunrise::client::hooks::bootflow::opening_authority::type31_incident;
...
void test_no_claim_surface() {
    std::ifstream stream("D:\\Sunrise-port\\Sunrise\\src\\client\\hooks\\bootflow\\opening_"
