...
#include <fstream>
#include <vector>
namespace event=sunrise::server::runtime::activity::public_event;
...
namespace cf=sunrise::server::runtime::activity::adventure::cue_feedback;
namespace cb=sunrise::server::runtime::activity::adventure::native_bridge;
namespace capture=sunrise::client::hooks::bootflow::public_event_participant_capture;
