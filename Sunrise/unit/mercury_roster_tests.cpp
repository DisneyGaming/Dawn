...
namespace lifetime=sunrise::server::bap::encrypted::push::activity::roster_lifetime;
...
int main(int argc,char** argv){
    ...
    for(bool publicEvent:{false,true})for(int adventure=-1;adventure<3;++adventure){
        ...
        auto packet=std::make_unique<std::array<std::byte,sunrise::client::network::kBapFrameCapacity>>();std::size_t written{};
