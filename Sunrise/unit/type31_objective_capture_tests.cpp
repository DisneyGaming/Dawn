...
using namespace sunrise::client::hooks::bootflow::type31_capture;
using sunrise::state::activity::ActivationGeneration;
using sunrise::state::activity::ActivityIncarnation;
using sunrise::state::activity::ActivityInstanceKey;
using sunrise::state::activity::ModuleGeneration;
using sunrise::state::activity::NativeActivationKey;
...
struct FakeOwnerOperations final {
    ...
    sunrise::client::hooking::CallGate point_gate{};
    sunrise::client::hooking::CallGate drain_gate{};
...
void production_owner_policy_retains_failures_and_isolates_reinstall_epochs() {
    ...
    {
        sunrise::client::hooking::CallGate::Scope pointCall(operations.point_gate);
        sunrise::client::hooking::CallGate::Scope drainCall(operations.drain_gate);
