#define SUNRISE_GHOST_VM_BRIDGE_UNIT_TEST 1
#include <algorithm>
#include <array>
#include <atomic>
#include <cstddef>
...
using namespace sunrise::client::hooks::bootflow::opening_authority::ghost_vm_bridge_capture;
...
#if defined(SUNRISE_GHOST_VM_BRIDGE_REAL_ARTIFACT_TESTS)
