...
namespace extract = sunrise::client::content::scenarios;
namespace layouts = sunrise::state::build_data::scenarios;
namespace rec = sunrise::state::build_data::cache::records;
namespace packages = sunrise::middleware::content::packages::reader;
namespace authored = sunrise::state::activity::coo::open_world;
namespace sectors = sunrise::state::activity::coo::lost_sector;
namespace sectorProfiles = sunrise::server::runtime::activity::lost_sector::catalog;
namespace admission = sunrise::server::runtime::activity::registry;
