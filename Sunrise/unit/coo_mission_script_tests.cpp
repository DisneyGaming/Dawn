...
int main() {
    ...
    std::ifstream input("Sunrise/unit/fixtures/mission_script_alternate.lua",std::ios::binary);CHECK(input.good());
    ...
    auto doc=s::MissionDocument::read("Sunrise/unit/fixtures/mission_script_alternate.lua",profile,error);
