...
namespace native=sunrise::client::hooks::bootflow::eater_platform_contact_native;
namespace cache=sunrise::client::hooks::bootflow::eater_platform_binding_cache;
...
int eater_platform_contact_native_tests() {
        ...
        ok&=expect(!f.current(),"live volume shape replacement rejects cached component set");}
    {
        ...
        std::uintptr_t found{};
        ok&=expect(sunrise::client::hooks::bootflow::coo_native::component<Read,1024>(
