...
int main() {
    ...
    const rt::Owner owner{99,{7}};rt::Service service;
    ...
    rt::Service assignedService;CHECK(assignedService.begin(assignedOwner,std::span(&assignedCap,1),11));
    ...
    rt::Service many;CHECK(many.begin({77,{1}},capabilities,11));
