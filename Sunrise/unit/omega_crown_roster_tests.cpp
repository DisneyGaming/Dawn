...
namespace route=sunrise::server::bap::encrypted::push::activity::omega_route_roster;
...
void opening_ack() {
    ...
    static sense::SenseUpdate result;
    std::size_t consumed{};
    check(sense::parse_sense_update(sunrise::unit::fixtures::kOmegaRevealAcknowledgement,result,consumed),"captured opening parses");
