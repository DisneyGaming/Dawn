...
namespace sentinel = sunrise::client::hooks::bootflow::legacy_owner_sentinel;
namespace quarantine = sunrise::client::hooks::bootflow::legacy_owner_quarantine;
...
int main(int argc, char** argv) {
    const std::filesystem::path bootflowRoot =
        argc > 1 ? std::filesystem::path{argv[1]}
                 : std::filesystem::path{"Sunrise/src/client/hooks/bootflow"};
