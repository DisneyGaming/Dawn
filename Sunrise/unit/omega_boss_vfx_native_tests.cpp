...
namespace graph=sunrise::client::hooks::bootflow::omega_boss_graph;
namespace hooking=sunrise::client::hooking;
namespace omega_boss_eye_diagnostics=sunrise::client::hooks::bootflow::omega_boss_eye_diagnostics;
namespace omega_boss_vfx_start=sunrise::client::hooks::bootflow::omega_boss_vfx_start;
