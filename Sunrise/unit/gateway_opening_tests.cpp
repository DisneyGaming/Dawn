...
void ai_lattice_tests() {
    ...
    CHECK(sunrise::state::activity::omega::ikora::write_gate(b,false));CHECK(actual==accepted);
...
void vance_native_path_tests() {
    namespace path=sunrise::client::hooks::bootflow::gateway_vance_native_path;
...
void module_native_path_tests() {
    namespace path=sunrise::client::hooks::bootflow::gateway_module_native_path;
    ...
    namespace damage=sunrise::client::hooks::bootflow::gateway_module_damage;
...
void ending_identity_and_codec_tests() {
    namespace identity=sunrise::client::hooks::bootflow::gateway_module_identity;
    ...
    for(bool active:{false,true}) {
        ...
        CHECK(sunrise::state::activity::omega_rescue_npc::write_source(b,7,active));
