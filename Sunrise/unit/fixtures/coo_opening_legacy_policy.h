...
namespace core = sunrise::core;
namespace middleware = sunrise::middleware;
...
void apply(Session& session, const sunrise::middleware::bap::activity_message::sense_update::SenseUpdate& update,
           const sunrise::server::bap::encrypted::activity_message::omega_opening_intake::Context& c, bool quiesced=false) {
    namespace admission = sunrise::server::bap::encrypted::activity_message;
