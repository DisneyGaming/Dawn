...
int main(int argc,char** argv) {
    ...
    for(std::size_t index=0;index<mercury::kForestOverlays.size();++index) {
...

        {
            ...
            check(sunrise::middleware::bap::activity_message::native::cue::valid(navigation.cues,navigation.roster),
    ...
    namespace predicates=sunrise::middleware::bap::activity_message::native::player_predicates;
