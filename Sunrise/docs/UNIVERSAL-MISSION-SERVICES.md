...
## Server-native migration

See [SERVER-NATIVE-MISSION-MIGRATION.md](SERVER-NATIVE-MISSION-MIGRATION.md) for native plate authority, server receipt intake, dialogue retirement, removed Omega HUD mutation, and behavior hooks retained for manual review.
