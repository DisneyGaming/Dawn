...
public:
    ...
    [[nodiscard]] EndingRequest ending_request() const noexcept { return {frame_.enabled,frame_.moduleVulnerable,run_,publicationGeneration_+1U,frame_.sceneGeneration,moduleOwner_,frame_.moduleDestroyed}; }
...
private:
    ...
    std::uint64_t conversationAt_{};
    ModuleReceipt moduleOwner_{}; SceneReceipt sceneOwner_{};
