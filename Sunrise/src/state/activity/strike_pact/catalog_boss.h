...
// encounter (sunrise-strike-missions/strike_pact/boss.lua, with music.lua for the sections and
...
// The SDK stamps slot ids with object tags only; registry keys come from the accepted Sunrise
