...
// scenario 80F54AE7 through the Sunrise activity SDK export and the live roster
// publications of the accepted Sunrise host build (registry keys per object tag).
#pragma once
#include <array>
#include <cstdint>
#include <span>
...
// the named member (sq_cabal_anchor's Gladiator). Cohorts are the accepted Sunrise stages.
struct Spawn final {
