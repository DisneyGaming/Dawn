...
struct ScenarioRecord {
    ...
    /** Roster table indices published only in selected bubbles. */
    std::array<std::uint16_t, scenarios::kDestinationBubbleGroupCapacity> bubbleGroups{};
    /** Bubble masks stored low bubble first. */
    std::array<std::array<std::uint8_t, scenarios::kBubbleMaskBytes>,
               scenarios::kDestinationBubbleGroupCapacity>
        bubbleGroupMasks{};
    /** Per-slice authored group counts; element zero of each nonempty row is its scenario root. */
    std::array<std::uint8_t, scenarios::kBubbleCapacity> authoredGroupCounts{};
    std::array<std::array<std::uint16_t, scenarios::kDestinationAuthoredGroupCapacity>,
               scenarios::kBubbleCapacity>
        authoredGroups{};
...
struct RosterGroupRecord {
    ...
    std::array<std::uint32_t, scenarios::kRosterSlotCapacity> descriptorTags{};
    std::array<std::uint32_t, scenarios::kRosterSlotCapacity> descriptorOffsets{};
    std::array<std::uint32_t, scenarios::kRosterSlotCapacity> componentClasses{};
    std::array<std::uint32_t, scenarios::kRosterSlotCapacity> senseSchemas{};
    std::array<std::uint32_t, scenarios::kRosterSlotCapacity> authSchemas{};
};
...
static_assert(sizeof(ScenarioRecord)
              == scenarios::kNameCapacity + sizeof(std::uint32_t) + 10 * sizeof(std::uint8_t)
                     ...
                     + scenarios::kBubbleCapacity
                           * scenarios::kDestinationAuthoredGroupCapacity * sizeof(std::uint16_t));
...
static_assert(sizeof(RosterGroupRecord)
              == 2 * sizeof(std::uint32_t) + sizeof(std::uint16_t)
                     ...
                     + 5 * scenarios::kRosterSlotCapacity * sizeof(std::uint32_t));
