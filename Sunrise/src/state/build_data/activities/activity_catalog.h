...
struct Definition {
    ...
    [[nodiscard]] std::string_view name() const noexcept { return package.data(); }
};
struct Presentation {
    ...
    std::uint8_t contentGroup{}; // Original release index; releases::unresolved when not established
