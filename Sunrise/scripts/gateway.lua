...
local opening = graph("opening", "Gateway traversal and Forest gate", {
    step("landing", "landing.entered"),
    step("presentation", parallel("objective.find_gateway", "dialogue.ikora_gateway"), {after={"landing"}}),
    step("recess", "recess.entered", {after={"presentation"}}),
    step("marchers", "marchers.start", {after={"landing"}}),
    ...
    step("shelf_entry", "shelf.entered", {after={"recess_cannons"}}),
    step("shelf_initial", "shelf.initial", {after={"shelf_entry"}}),
    ...
    step("end_entry", "end.entered", {after={"shelf_clear"}}),
    step("end_initial", "end.initial", {after={"end_entry"}}),
    ...
    step("mainland", parallel("mainland.outskirts", "mainland.center", "objective.forest_gate"), {after={"lighthouse_landing"}}),
    step("battle_intro", "mainland.intro", {after={"mainland"}}),
    step("forest_description", "dialogue.forest_gate", {after={"battle_intro"}}),
    step("mainland_clear", "mainland.cleared", {after={"mainland"}}),
    step("forest_approach", "forest.approached", {after={"mainland_clear", "forest_description"}}),
...
local ending = graph("ending", "Gateway return, Lighthouse defense and Brother Vance", {
    ...
    step("approach", "finale.approached", {after={"return"}}),
    step("wave_one", "finale.wave_1", {after={"approach"}}),
...
return mission{
    ...
    phases={"opening", "ending"}, observation_start="landing.entered",
